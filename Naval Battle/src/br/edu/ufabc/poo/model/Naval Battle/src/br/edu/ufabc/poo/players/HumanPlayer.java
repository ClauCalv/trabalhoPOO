...
public class HumanPlayer extends Player {
	...
	public void placeShips() {
		...
		/** Dica: tentem fazer igual na IA e usar o battleMap pra posicionar seus navios, aí não
		 * tem que ficar criando variável nova. Só lembrem de limpar depois, "battleMap.clearMap()",
